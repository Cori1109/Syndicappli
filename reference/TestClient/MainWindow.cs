    ...
    public partial class MainWindow : Form
    {
        ...
        private void onConnect(object sender, EventArgs e)
        {
            BeginInvoke((MethodInvoker)(() => {
                ...
                StreamingService ss = _obs.GetStreamSettings();
                //ss.Settings = new StreamingServiceSettings();
                
                ss.Settings.Server = "rtmp://localhost/";
                ss.Settings.Key = "romi";
                //_obs.SetStreamingSettings(ss,true);
                _obs.SetStreamSettings(ss, true);
                //_obs.SetSourceSettings()
                SourceSettings ss1 =  _obs.GetSourceSettings("Video Capture Device");
