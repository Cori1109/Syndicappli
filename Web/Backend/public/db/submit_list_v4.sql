...
--
-- Table structure for table `submit_list_v4`
--

CREATE TABLE `submit_list_v4` (
  `id` int(11) NOT NULL,
  ...
  `take_challenge_type` int(1) NOT NULL DEFAULT '-1' COMMENT '0: skip, 1: frontend 2: fullstack',
  ...
  `javascript_test_type` int(1) NOT NULL DEFAULT '-1',
...
--
-- Indexes for table `submit_list_v4`
--
ALTER TABLE `submit_list_v4`
  ADD PRIMARY KEY (`id`),
  ADD KEY `uid` (`uid`),
  ADD KEY `email` (`email`);
...
--
-- AUTO_INCREMENT for table `submit_list_v4`
--
ALTER TABLE `submit_list_v4`
