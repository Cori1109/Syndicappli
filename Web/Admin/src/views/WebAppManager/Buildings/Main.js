...
const Main = (props) => {
    ...
    const handleClickEmptyTrashBuilding = () => {
        if(globalState.trash.type === 'manager_building' && globalState.trash.ID.length != 0)  
        setOpenDelete(true);
    };
    ...
    const handleDelete = () => {
        ...
        ManagerService.emptyTrashBuilding(data)
            .then(
                response => {
    ...
    return (
        <div className={classes.root}>
            ...
            <div className={classes.tool}>
                ...
                >
                    <Tab xs={12} sm={4} label="Immeubles" {...a11yProps(0)} className={classes.tabTitle} disableRipple />
            ...
            <div className={classes.body}>
                ...
                <TabPanel value={value} index={1}>
                    <TrashBuildings refresh={refresh} />
                </TabPanel>
            </div>
            <DeleteConfirmDialog
